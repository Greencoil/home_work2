...
В данной ветке мы присоединим добавим в файл изображение для отработки состояния ignore и наблюдения за магией данного процесса. Для добавления изображения необходимо прописать:
